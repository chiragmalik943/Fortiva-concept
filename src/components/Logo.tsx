  ...
  return (
    <span className={`relative inline-block ${className}`}>
      {/* invisible <img> establishes the correct box from the file's own
          ...
          it) at a minimum 32px height; the visible mark is a same-size,
          absolutely-positioned mask so it can be tinted navy or white */}
      <img src={images.logo} alt="" aria-hidden="true" className="invisible h-8 w-auto" />
      <span
        aria-hidden="true"
