...
export const images = {
  ...
  insuranceIndividual: '/img-2.png',
  insuranceCorporate: '/img-3.png',
  insuranceFamily: '/img-4.png',

  splitImage: '/img-5.png',
  splitImageMobile: '/img-5-mobile.png',

  forStageFamily: '/img-6.png',
  forStageEmployees: '/img-7.png',
  forStageYou: '/img-8.png',

  blogPost1: '/img-9.png',
  blogPost2: '/img-10.png',
  blogPost3: '/img-11.png',
